/* if else and nested if else  */ var maths = Number(
  prompt('enter your marks in the maths subject'),
);
...
console.log(avg.toFixed(2)); /* .toFixed(2)  : - for limiting the digits after the point*/
if (avg >= 85) {
  if (avg >= 95 && avg <= 95) {
